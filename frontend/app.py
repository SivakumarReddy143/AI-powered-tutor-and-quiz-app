...
with st.sidebar:
    ...
    subject = st.selectbox("📖 Select Subject",
                        ["Machine learning", "Deep learning", "Generative AI",
                         "natural language processing", "DSA", "aptitude","sudo code based questions"])
        ...
        with st.spinner("Creating quiz questions..."):
            try:
                ...
                if "formatted_quiz" in response and response["formatted_quiz"]:
                    ...
                    html(response["formatted_quiz"], height=num_questions * 460)
                    # st.success(response["formatted_quiz"])
                else:
